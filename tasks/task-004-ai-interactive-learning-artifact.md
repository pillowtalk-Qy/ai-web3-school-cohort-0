...
- Artifact: `experiments/ai-learning-demo/`
...
```text
https://github.com/pillowtalk-Qy/ai-web3-school-cohort-0/tree/main/experiments/ai-learning-demo
```

Main demo file:

```text
https://github.com/pillowtalk-Qy/ai-web3-school-cohort-0/blob/main/experiments/ai-learning-demo/index.html
```
...
用户打开 `experiments/ai-learning-demo/index.html` 后：
...
- `node --check experiments/ai-learning-demo/app.js`
- Static server smoke test on `http://localhost:4187/`
- Secret scan against `experiments/ai-learning-demo`
